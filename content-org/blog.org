...
* TODO tools for learning Japanese                                :@japanese:
:PROPERTIES:
...
programmers.
Given that I am one of those myself I know what it feels like when has an idea for a project
that will help them study japanese so much more efficiently.
Just a couple hours of work and efficiency will increase. It will be worth it.
Spoiler: It will be worth it for other people. But the efficiency increase will not make
...
Here is a list of tools I have used/or use and like. Tools that don't meet these two criteria are omitted.
...
*** jpdb mpv plugin
Usable for patreons only. Makes mining sentences from video a breeze.

*** [[https://github.com/max-kamps/jpdb-browser-reader][jpdb-browser-reader]]
A browser based popup dictionary that very deeply integrates with jpdb. Still has some open todo's but
its looking very promising.

*** [[https://github.com/kampffrosch94/jpdb-connect][jpdb-connect]]
Built by me. Allows you to mine sentences into jpdb from yomichan and JL.
Will probably be largely super seeded by the various jpdb reader variants that people are developing right now.
...
An awesome popup dictionary made with VNs in mind. Can be laid over the text box of a VN and used instead.
...
Scales up low res VNs (or anything really). Works pretty well.
