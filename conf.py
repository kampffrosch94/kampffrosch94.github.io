...
BLOG_AUTHOR = "Johannes Otto Karl"  # (translatable)
BLOG_TITLE = "frogblog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://kampffrosch94.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://kampffrosch94.github.io/"
BLOG_EMAIL = "johanneskarl.dev@gmail.com"
BLOG_DESCRIPTION = "Blog about my misadventures."  # (translatable)
